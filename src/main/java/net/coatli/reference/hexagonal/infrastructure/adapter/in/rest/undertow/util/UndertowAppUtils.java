package net.coatli.reference.hexagonal.infrastructure.adapter.in.rest.undertow.util;

import net.coatli.reference.hexagonal.application.port.out.logging.LoggingPortOut;
import net.coatli.reference.hexagonal.infrastructure.bootstrap.ApplicationProperties;
