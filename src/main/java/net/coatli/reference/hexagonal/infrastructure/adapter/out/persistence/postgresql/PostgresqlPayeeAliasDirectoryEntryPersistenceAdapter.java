package net.coatli.reference.hexagonal.infrastructure.adapter.out.persistence.postgresql;
...
import net.coatli.reference.hexagonal.application.port.out.persistence.exception.PayeeAliasDirectoryEntryPersistenceException;
import net.coatli.reference.hexagonal.application.port.out.transformation.JsonTransformationPortOut;
import net.coatli.reference.hexagonal.domain.model.PayeeAliasDirectoryEntry;
